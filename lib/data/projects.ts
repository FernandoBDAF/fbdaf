...
export const projects: Project[] = [
  {
    ...
    description:
      'Comprehensive enterprise management system handling operations, finance, accounting, and compliance for a growing company.',
    longDescription:
  ...
  },
  {
    ...
    description:
      'Reference microservice architecture demonstrating distributed systems with orchestration, caching, authentication, and asynchronous workers.',
    longDescription:
  ...
  },
  {
    ...
    description:
      'Advanced GraphRAG pipeline for extracting and analyzing knowledge from YouTube content with comprehensive observability.',
    longDescription:
  ...
  },
  {
    ...
    description:
      'Intelligent context management system for optimizing LLM interactions with structured context preservation.',
    longDescription:
